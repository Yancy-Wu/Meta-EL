...
from mel.datasets.zeshel.overall import OverallZeshelDataset
...
def main(config: dict):
    ...
    dataset = OverallZeshelDataset('../datasets/mel_zeshel_overall/', {
    ...
    for way_num in config['way_num']:
        test_dataset = OverallZeshelDataset('../datasets/mel_zeshel_overall/', {
            'TRAIN_TASKS_NUM': 0,
            'VALID_TASKS_NUM': 0,
